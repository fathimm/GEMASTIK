...
arduino = serial.Serial('/dev/ttyUSB0', 9600)  # Ganti dengan port Arduino Anda
    ...
    while True:
        ...
        if not success:
            ...
            with torch.no_grad():
                ...
                predicted_label = cabe_label[predicted.item()]
                confidence = probabilities[0][predicted.item()].item() * 100

            # Add the label and confidence to the frame
            label_with_confidence = f'{predicted_label}: {confidence:.2f}%'
